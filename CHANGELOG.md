...
- Add #[must_use] to query functions
- Split git.rs into submodules
- Split output/cleanup.rs into submodules
...
- Add safety documentation for thread-local Cell usage

### Fixed

- Improve code quality for test isolation and UI stability
...
- Use force delete for squash-merged branches

## [0.6.0] - 2026-02-04

### Added

- Implement hybrid merge detection for branch cleanup
